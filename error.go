...
type (
	...
	// It accepts an id, a message and optional key value pairs and produces errors that
	// implement ServiceError.
	// The id is reported to the client so that it can be correlated with e.g. service logs.
	// If the message is a string or a Stringer then the string value is used.
